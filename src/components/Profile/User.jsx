    ...
    <>
      ...
      <Card className="rounded-3 my-3 mt-2">
        <Card.Body className="p-3">
          ...
          <div className="d-flex">
            <img className=" mx-2" src="https://images.pexels.com/photos/374918/pexels-photo-374918.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="numbers" style={{ width: "45px", height: "45px" }} />
