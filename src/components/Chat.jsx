...
function Chat() {
  ...
  return (
    <>
      <div id="chat" className="chat bg-white position-fixed p-2 border  rounded">
        <Row className="align-items-center">
          <Col xs={2}>
            <button type="button" className=" position-relative   p-0 border-0 bg-white">
              <img src="" alt="avatar" width={"37rem"} height={"37rem"} className="rounded-circle object-fit-cover" />
